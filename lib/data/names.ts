export const MALE_FIRST_NAMES: readonly string[] = [
  ...
  "Russell","Louis","Philip","Bobby","Johnny","Bradley","Oliver","Liam",
];
...
export const FEMALE_FIRST_NAMES: readonly string[] = [
  ...
  "Joan","Evelyn","Lauren","Judith","Olivia","Frances","Martha","Cheryl",
  "Megan","Andrea","Hannah","Jacqueline","Ann","Jean","Alice","Kathryn",
  "Gloria","Teresa","Doris","Sara","Janice","Julia","Marie","Madison",
  "Grace","Judy","Theresa","Beverly","Denise","Marilyn","Amber","Danielle",
  "Rose","Brittany","Diana","Abigail","Charlotte","Sofia","Avery","Ella",
  "Scarlett","Aria","Chloe","Penelope","Layla","Riley","Zoey","Nora",
];
...
export const LAST_NAMES: readonly string[] = [
  ...
  "Mitchell","Carter","Roberts","Phillips","Evans","Turner","Torres","Parker",
