...
import { CommunityIdeas } from "@/components/home/CommunityIdeas";
...
export default function RuMainPage() {
  return (
    <>
      ...
      {/* 3b. Trending This Week */}
      <TrendingSection locale="ru" />

      {/* 3c. Recently Added */}
      <RecentlyAddedSection locale="ru" />
