...
export type RandomNumberSeparator = "newline" | "comma" | "space" | "comma-space";
export const RANDOM_NUMBER_SEPARATORS: readonly RandomNumberSeparator[] = [
  "newline",
  "comma",
  "space",
  "comma-space",
...
const SEPARATOR_CHARS: Record<RandomNumberSeparator, string> = {
  newline: "\n",
  comma: ",",
  space: " ",
  "comma-space": ", ",
...
export function formatRandomNumberResults(
  ...
  separator: RandomNumberSeparator = "newline",
): string {
  return numbers.join(SEPARATOR_CHARS[separator]);
}
