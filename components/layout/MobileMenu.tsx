  ...
  return (
    <div className="sm:hidden">
      <button
        ...
        className={cn(
          "inline-flex h-10 w-10 items-center justify-center rounded-[var(--radius)] text-[var(--foreground)]",
      ...
      >
        <nav aria-label="Mobile" className="flex flex-col gap-1 p-4">
          ...
          <Link
            ...
            onClick={closeMenu}
            className={cn(
              "mt-2 inline-flex h-11 items-center justify-center rounded-[var(--radius)] bg-[var(--primary)] px-4 text-base font-medium text-[var(--primary-foreground)]",
