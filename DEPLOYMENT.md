# Deploying GenHub to Production

This guide walks through taking GenHub from local development to a
...
2. From the `GenHub/` folder, initialize and push:
